package com.guide.organizerservice.business.services.impl
...
import com.guide.organizerservice.data.repository.AddressRepository
import com.guide.organizerservice.data.repository.EventRepository
import com.guide.organizerservice.data.repository.OrganizerRepository
import com.guide.organizerservice.proxy.UserServiceProxy
...
class OrganizerServicesImpl {
    ...
    class OrganizerServicesImpl(
        ...
        @Autowired
        val userServiceProxy: UserServiceProxy
    ) : OrganizerServices {
            ...
            try {
                if (filterModel.country != null && filterModel.city != null) {
                    ...
                    if (filterModel.eventType != null) {
                        var temp = selectedEventList.filter { s -> s.type!!.equals(filterModel.eventType) }
                        selectedEventList = temp.toMutableList()
                    }
                    ...
                    if (filterModel.onlyFollow != null && filterModel.userId != null && filterModel.onlyFollow == true) {
                        ...
                        var currentUser =userServiceProxy.userFindById(filterModel.userId!!)
